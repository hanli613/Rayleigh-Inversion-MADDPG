...
def get_args():
    ...
    # Environment
    parser.add_argument("--scenario-name", type=str, default="Reilaygh_scenario", help="name of the scenario script")
    ...
    parser.add_argument("--buffer-size", type=int, default=int(1000000), help="number of transitions can be stored in buffer")
